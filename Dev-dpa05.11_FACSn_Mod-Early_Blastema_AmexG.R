...
BL_dpa05.11 <- readRDS(BL_dpa05.11_SeuratObj.RDS)
...
DimHeatmap(Cluster.5.17_subset, dims = 1:16, cells = 500, balanced = TRUE, ncol = 4,  fast = F) 
DimHeatmap(Cluster.5.17_subset, dims = 17:32, cells = 500, balanced = TRUE, ncol = 4,  fast = F) 
DimHeatmap(Cluster.5.17_subset, dims = 33:48, cells = 500, balanced = TRUE,  ncol = 4, fast = F) 
DimHeatmap(Cluster.5.17_subset, dims = 49:64, cells = 500, balanced = TRUE,  ncol = 4, fast = F) 
DimHeatmap(Cluster.5.17_subset, dims = 65:80, cells = 500, balanced = TRUE,  ncol = 4, fast = F) 
DimHeatmap(Cluster.5.17_subset, dims = 81:96, cells = 500, balanced = TRUE,  ncol = 4, fast = F) 
dev.off()
